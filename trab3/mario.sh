...
# 2024/06/24 (Lucas Araujo Carvalho)
# Adicionado a opção de jogar com o Luigi, passando 'luigi' como argumento do programa
# 	Exemplo: ./mario.sh luigi
# 	define novas variaveis _jog, _displayName e _letterName para serem usadas no jogo
#	_jog qual sprite de personagem sera usado
#	_displayName indica o nome do personagem que sera exibido na tela
# 	_letterName indica a letra usada na tela de vidas
# Capturando o sinal SIGINT para sair do jogo corretamente
#	Usa trap para capturar o sinal e chama a função Sair
# Modifica a tecla ENTER para 'p'
...
function Splash {
	...
	_canvas[13]="${_edgeScreen}${_spaceIni}                             █░░░░$_letterName███                                          ${_spaceFim}${_edgeScreen}"
...
function DrawJogador {
	...
	for (( _l=_tmpIni; _l<=_tmpJogHeight; _l++ )); do
		...
		_tmp="${_jog}${_jogSide}${_jogSprite}[$_l]"
...
if [ "$_playerChoice" == "luigi" ]; then # Verifica se foi passado o personagem luigi como parametro
	_jog=_luigi # Define o personagem como luigi
	_displayName="LUIGI" # Define o nome do personagem como luigi
	_letterName="L" # Define a letra do personagem como L
else
	_jog=_mario # Define o personagem como mario
	_displayName="MARIO" # Define o nome do personagem como mario
	_letterName="M" # Define a letra do personagem como M
fi

# Mapa do score no topo da tela
_scoreTitle0="     $_displayName                                   WORLD               TIME           "
...
# Mapa de caracters do jogador mario
...
# Mapa de caracters do jogador luigi
...
# verifica se SIGINT foi passada para finalizar o programa corretamente
trap 'Sair' SIGINT
